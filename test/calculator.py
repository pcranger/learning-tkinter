...
button_clear.grid(row= 4, column= 1, columnspan = 2)# button, or content of the button actually lies in column 1, but tkinter draws so that it occupies(span) 2 columns
